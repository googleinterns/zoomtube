...
public final class CommentUtilTest {
  ...
  public void createComment_shouldReturnCommentFromEntity() throws IOException {
    ...
    entity.setProperty(CommentUtil.TIMESTAMP_MILLISECONDS, timestamp);
    ...
    assertThat(comment.timestampMilliseconds()).isEqualTo(timestamp);
  ...
  public void createEntity_noParent_shouldReturnEntityWithProperties_noParent() throws IOException {
    ...
    assertThat(entity.getProperty(CommentUtil.TIMESTAMP_MILLISECONDS)).isEqualTo(timestamp);
